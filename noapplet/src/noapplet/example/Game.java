...
public class Game {
    public Game(int mode){
        if(mode == 1){Player.Human();}
        else{Player.Strategy();}
    }
    ...
    public static void setAIMove(int row, int col){Board.placeStone(row,col,false);}
    public static int getBoardSize(){return Board.board.length;}
}
